...
tags: 大数据 底层存储 分布式 Hbase 2019 年
...
Hbase 下载链接(版本更新太快,存在链接失效的可能性): [https://mirrors.cnnic.cn/apache/hbase/2.2.1/hbase-2.2.1-bin.tar.gz](https://mirrors.cnnic.cn/apache/hbase/2.2.1/hbase-2.2.1-bin.tar.gz)
...
修改 hbase-env.sh，加入下面三行（注意 java 和 hadhoop 路径）
...
- 推荐阅读
  - [hbase 原理](https://blog.csdn.net/fanren224/article/details/84594842)
- 其他
