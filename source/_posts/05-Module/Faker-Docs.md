...
faker 官方文档链接:[https://faker.readthedocs.io/en/latest/index.html)](https://faker.readthedocs.io/en/latest/index.html)
faker 函数列表参考:
...
1. factory_choice_generator 随机生成 list 中一项
2. Gen_length_Num 随机生成指定长度数字
3. hanzi2pinyin 汉字转拼音
4. fake_random_sentence 传入 list，生成随机组合的 list
